 ...
 * VERSION: 1.25
 * FEATURES: Centered Headers, Bio before Coupon, Click-Outside-to-Close.
 */
    ...
    if (tierL === 'premium' || tierL === 'plus') {
        ...
        body.innerHTML = `
            <div style="text-align:center; width:100%; padding-bottom: 20px; border-bottom: 2px solid #000; margin-bottom: 25px;">
                ...
                <p style="color:#666; font-style:italic; font-size: 1.2rem; margin: 5px 0 0 0; width:100%;">${biz.Category} | Est. ${biz.Established || 'N/A'}</p>
            </div>
            ...
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap:30px;">
                ...
                <div style="padding: 10px;">
                    ...
                    <div style="border: 2px solid #000; height: 280px; background:#eee; box-shadow: 4px 4px 0px rgba(0,0,0,0.1); overflow:hidden;">
                        <iframe width="100%" height="100%" frameborder="0" style="border:0;" src="https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=${mapAddr}"></iframe>
                    </div>
                </div>
            </div>
