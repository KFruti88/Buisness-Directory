...
<head>
    ...
    <style>
        /* Modal Style for Pop-out Engine */
        #premium-modal {
            display: none;
            position: fixed;
            z-index: 2000;
...
<body>
    ...
    <header class="main-title">
        ...
        <div class="newspaper-meta single-row">
            <div class="meta-item left-meta" id="header-info">VOL. 1 — NO. 1 | LOADING...</div>
            ...
            <div class="meta-item">
                <select id="cat-select" onchange="applyFilters()">
                    ...
                    <option value="Manufacturing">🏗️ Manufacturing</option>
                    <option value="Bars">🍺 Bars & Taverns</option>
                    ...
                    <option value="Support Services">🛠️ Support Services</option>
    ...
    <script src="modal.js?v=1.12"></script>
    <script src="layout.js?v=1.12"></script>
    <script>
