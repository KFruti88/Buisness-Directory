/**
 * PROJECT: Clay County Master Directory v9.9.5
 * LOCK: Logo = Col A | Coupon Media = Col O | Coupon Text = Col P
            ...
            <div class="modal-inner-padding" style="display: flex; flex-direction: column; height: 100%; justify-content: flex-start;">
                ...
                <div style="border-bottom: 3px solid #000; padding-bottom: 10px; margin-bottom: 15px;">
                    <div style="display: flex; gap: 20px; align-items: center;">
                        <img src="${CONFIG.IMAGE_REPO}${biz.id}.jpeg" style="width:80px; height:80px; border:2px solid #000; background:#fff; object-fit: contain;" onerror="this.src='https://via.placeholder.com/80?text=LOGO';">
                        <div>
                            <h2 style="margin:0; font-size: 2.2rem; text-transform: uppercase; line-height:1; color:#000;">${biz.name}</h2>
                            <p style="margin:5px 0 0 0; font-weight: 900; font-size: 1rem; color:#444;">📁 ${biz.category} | Est. ${biz.established || 'N/A'}</p>
                        </div>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1.2fr; gap: 25px; margin-bottom: 15px;">
                    ...
                    <div style="border: 3px solid #000; height: 200px; box-shadow: 8px 8px 0px rgba(0,0,0,0.1); overflow:hidden;">
                ...
                <div style="border-top: 3px solid #fe4f00; padding-top: 15px; text-align: center; flex-grow: 1; display: flex; flex-direction: column; justify-content: center;">
                    <p style="margin:0 0 10px 0; font-weight:900; color:#fe4f00; text-transform:uppercase;">🎫 Special Community Offer</p>
                    <img src="${biz.couponMedia}" style="max-height: 140px; width: auto; margin: 0 auto; border: 2px solid #fe4f00; box-shadow: 5px 5px 0px rgba(254,79,0,0.2);" onerror="this.parentElement.style.display='none';">
